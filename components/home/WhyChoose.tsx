...
const cards: Card[] = [
  {
    ...
    desc: "Strategy, development, QA, and training under one roof.",
    Icon: IconBrowserGear,
  },
  {
    title: "Agile Delivery ",
    desc: "Fast, flexible, scalable execution.",
    Icon: IconTeamSprout,
  },
  {
    title: "Outcome-Oriented ",
    desc: "Every project tied to measurable results.",
    Icon: IconNodes,
  },
  {
    title: "Client-First Approach ",
    desc: "Solutions tailored to unique needs.",
    Icon: IconNodes,
  },
];
  ...
  return (
    <section aria-labelledby="why-choose" className="bg-background">
      <div className="px-5 md:px-20 lg:px-24 py-16 md:py-20">
        ...
        {/* CTA */}
        <div className="mt-10 md:mt-14 flex justify-center cursor-pointer">
